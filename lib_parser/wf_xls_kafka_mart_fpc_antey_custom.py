...
from extract_from_antey import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_antey_custom',
...
def wf_xls_kafka_mart_fpc_antey_custom():
...
wf_xls_kafka_mart_fpc_antey_custom()
