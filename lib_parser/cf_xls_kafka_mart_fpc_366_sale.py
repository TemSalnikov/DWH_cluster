...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_366_sale',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/36,6/продажи/',
...
def cf_xls_kafka_mart_fpc_366_sale():
    @task
    ...
    def trigger_or_skip(parametrs: Optional[Dict], processing_files: Optional[Dict], **context):
        ...
        #     parametrs['files'] = processing_files
            ...
            #     trigger_dag_id="wf_xls_kafka_mart_fpc_366_sale",
            #     conf=parametrs,
        ...
        if processing_files:
            parametrs['files'] = processing_files
            result = trigger_dag(
                dag_id='wf_xls_kafka_mart_fpc_366_sale',
                run_id=f"triggered_by_{context['dag_run'].run_id}",
                conf={"xls_kafka_mart_fpc_366_sale":parametrs},
                execution_date=None,
...
cf_xls_kafka_mart_fpc_366_sale()