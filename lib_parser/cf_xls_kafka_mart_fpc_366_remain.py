...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_366_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/36,6/остатки/',
...
def cf_xls_kafka_mart_fpc_366_remain():
    @task
    ...
    def trigger_or_skip(parametrs: Optional[Dict], processing_files: Optional[Dict], **context):
        ...
        #     parametrs['files'] = processing_files
            ...
            #     trigger_dag_id="wf_xls_kafka_mart_fpc_366_remain",
            #     conf=parametrs,
        ...
        if processing_files:
            ...
            result = trigger_dag(
                ...
                conf={"xls_kafka_mart_fpc_366_remain":parametrs},
                execution_date=None,
...
cf_xls_kafka_mart_fpc_366_remain()